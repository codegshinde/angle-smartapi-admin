...
const _multipleOrderCancelHandler = require("../controller/handler/orders/multipleOrderCancelHandler");
...
async function postRoutes(fastify) {
    ...
    fastify.post("/user/order/cancel", _multipleOrderCancelHandler.multipleOrderCancelRouteOptions);
